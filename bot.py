...
# ============================================================
TOKEN             = os.getenv('DISCORD_TOKEN')              # YOUR TOKEN BOT
SOURCE_CHANNEL_ID = int(os.getenv('SOURCE_CHANNEL_ID'))     # ID SOURCE CHANNEL
TARGET_CHANNEL_ID = int(os.getenv('TARGET_CHANNEL_ID'))     # ID TARGET CHANNEL
